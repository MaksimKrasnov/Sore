...
namespace Store.Tests
{
    public  class OrderItemTests
    {
        ...
        [Fact]
        public void Count_WithNegativeValue_ThrowsArgumentOuOfRangeException()
        {
        ...
        [Fact]
        public void Count_WithZeroValue_ThrowsArgumentOuOfRangeException()
        {
            var orderItem = new OrderItem(0, 0m, 5);
        ...
        [Fact]
        public void Count_WithPositiveValue_ThrowsArgumentOuOfRangeException()
        {
            var orderItem = new OrderItem(0, 0m, 5);
