...
namespace Store.Tests
{
    public  class OrderTest
    {
        ...
        public void TotalPrive_WithEmptyItems_ReturnZero()
        {
            var order = new Order(1, new OrderItem[0]);
        ...
        [Fact]
        public void TotalCount_WithNonEmptyItems_CalculatesTotalPrice()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1,3,10m),
        ...
        [Fact]
        public void AddOrUpdateItems_WithExistingItem_UpdatesCount()
        {
            var order = new Order(1, new[]
{
                new OrderItem(1,3,10m),
        ...
        [Fact]
        public void AddOrUpdateItems_WithNonExistingItem_AddsItem()
        {
            var order = new Order(1, new[]
        {
                new OrderItem(1,3,10m),
